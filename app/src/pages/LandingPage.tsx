      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0" style={{ 
            background: "radial-gradient(ellipse 80% 50% at 50% -20%, rgba(125, 178, 255, 0.15), transparent), radial-gradient(ellipse 60% 40% at 80% 100%, rgba(45, 108, 223, 0.1), transparent)"
          }} />
          <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, hsl(240 6% 3% / 0.3), hsl(240 6% 3%))" }} />
        </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }}
              ...
              className="glass-card glow-border p-8 text-center"
            >
              <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-success/10" style={{ boxShadow: "0 0 20px hsl(142 71% 45% / 0.15)" }}>
